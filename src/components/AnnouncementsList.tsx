...
export default class AnnouncementsList extends Component<Props, State> {
  ...
  render() {
    ...
    const announ: AnnouncementData = {
      id: "idPrueba",
      titulo: "TituloPrueba",
      encargado: "nombrePrueba",
      codigo: "codPrueba",
    };
          ...
          announcements.map((announcement: AnnouncementData) => (
            <>
              <AnnouncementDetails
                ...
                modalId={`${modalId}-${announcement.id}`}
              />
              <div className="row mx-0 mb-2">
                <button
                  className="btn btn-info col-8 offset-2 btn-md announcement"
                  data-bs-toggle="modal"
                  data-bs-target={`#${modalId}-${announcement.id}`}
                >
                  <div className="row">
