  ...
  handleSave() {
    ...
    this.state.observaciones.map((e: any) => {
      if (e.revisado && !e.corregido && !e.observacion.correccion) {
        this.setState({
          message:
            "Existen observaciones mal corregidas vacias, por favor llene el campo Correccion",
          open: true,
        });
        bandera = true;
        return;
    ...
    if (!bandera) {
      ...
      ObservationsReviewDataService.saveObservations(da)
        .then((response) => {
          this.setState({
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <p className="container-fluid">
                Se generara{" "}
                <strong>
                  {this.state.esAdenda ? "una adenda" : "un contrato"}
                </strong>
              </p>
          ...
          <h3 className="row border-bottom border-dark">
            ...
            <div className="col-3">
              <button
                ...
                data-bs-toggle={`${this.state.correct ? "modal" : ""}`}
                data-bs-target={`#asd`}
                        ...
                        {observations &&
                          observations.map((ob: any, index) => {
                            ...
                            return (
                              <>
                                <TableRow
                                  className={`row ${ob.open ? "d-none" : ""}`}
                                >
                                  <button
                                    className="btn btn-info btn-block mt-2 text-white"
                                    style={{ fontSize: "17px" }}
                                    onClick={() => {
                                      this.openCloseObservation(
                                        ob.idObservacion
                                      );
                                    }}
                                  >
     ...
     : "fa-circle text-danger"
                                ...
                                >
                                  ...
                                  <div className="bg-info text-white">
                                    ...
                                    <div className="row">
                                      ...
                                      <div className="col-6">
                                        ...
                                        <input
                                          ...
                                          type="radio"
                                          name={`flexRadioDefault${ob.observacion.id}`}
                                          checked={ob.revisado && ob.corregido}
                                          id={`radioButtonObservation${ob.observacion.id}`}
                                          onChange={() => {
                                            this.handleCorrect(
                                              ob.idObservacion,
                                              true
                                    ...
                                    <div
                                      className={`row ${
                                        !this.state.observaciones[numbers]
                                          .revisado ||
                                        this.state.observaciones[numbers]
                                          .corregido
                                          ? "d-none"
                                    ...
                                    >
                                      <div className="col-4">Correccion:</div>
                                    </div>
                                    <div
                                      className={`row ${
                                        !this.state.observaciones[numbers]
                                      ...
                                      <div className="col-12">
                                        <textarea
                                          ...
                                          onChange={(e) => {
                                            ...
                                            let o: any =
                                              this.state.observaciones[ans];
                                            o.observacion.correccion =
                                              e.target.value;
                                            this.setState({
                                              observaciones: obs,
                                            });
              ...
              <div className="row mt-3">
                <div className="col-12">
                  <button
                    className="offset-3 col-6 btn-lg btn-success text-white"
