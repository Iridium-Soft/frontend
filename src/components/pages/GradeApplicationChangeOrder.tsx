...
export default class GradeApplicationChangeOrder extends Component<
  Props,
  State
> {
        ...
        <div className="container p-3 position-relative">
          <div className="row">
            <div className="col-12">
              <h3>Registrar calificiacion - Orden de Cambio</h3>
            </div>
          </div>
          ...
          <div className="form-group row m-3">
            <h5>
              <strong>Informacion de entrega de correccion</strong>
            </h5>
          </div>
          <div className="form-group row m-3">
            <label htmlFor="fechaContrato" className="col-md-4 col-form-label">
              Fecha de entrega de correccion
            </label>
